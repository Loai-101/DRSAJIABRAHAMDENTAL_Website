    ...
    en: {
      ...
      services: {
        ...
        items: [
          ...
          "Clear Aligners",
          "Pediatric Dentistry",
          "Ceramic Veneers / Hollywood Smile",
          "Crowns & Bridge",
          "Implants",
          "LASER Dentistry",
          "Teeth Whitening"
      ...
      doctors: [
        "Dr. SAJI C.ABRAHAM - Consultant Orthodontist",
        "Dr. SITA LAKSHMI - Dental Specialist – Endodontist"
      ],
      contact: {
        title: "Prefer to Call?",
        phone: "Call us directly",
        whatsapp: "WhatsApp us",
        phoneNumber: "+97317001231",
        whatsappNumber: "+97334671231",
        hours: "Working Hours: Saturday to Thursday 9:00 AM - 9:00 PM | Friday: Closed"
      },
      info: {
        ...
        items: [
          ...
          "Bring any relevant dental records or X-rays",
          "Initial consultation includes examination and treatment planning",
          "We provide comfortable, modern dental care in a relaxed environment"
        ]
      }
    },
    ar: {
      ...
      services: {
        ...
        items: [
          ...
          "طب الأسنان التجميلي",
          "جراحة الفم",
          "علاج قناة الجذر / علاج اللثة",
          "الأسنان المنطمرة",
          "تقويم الأسنان",
          "نظام دامون / الأقواس ذاتية الربط",
          "تقويم الأسنان اللساني",
          "المحاذاة الواضحة",
          "طب أسنان الأطفال",
          "القشور الخزفية / ابتسامة هوليوود",
          "التيجان والجسور",
          "زراعة الأسنان",
          "طب الأسنان بالليزر",
          "تبييض الأسنان"
      ...
      times: [
        ...
        "6:00 م", "6:30 م", "7:00 م", "7:30 م", "8:00 م", "8:30 م"
      ],
      doctors: [
        "الدكتور ساجي سي أبراهام - استشاري تقويم الأسنان",
        "الدكتورة سيتا لاكشمي - أخصائي طب الأسنان - أخصائي علاج لب الأسنان"
      ],
      contact: {
        title: "تفضل الاتصال؟",
        ...
        phoneNumber: "+97317001231",
        whatsappNumber: "+97334671231",
        hours: "ساعات العمل: السبت إلى الخميس 9:00 صباحًا - 9:00 مساءً | الجمعة: مغلق"
      },
      info: {
        title: "ما يمكن توقعه",
        items: [
          ...
          "أحضر أي سجلات أسنان أو أشعة ذات صلة",
          "الاستشارة الأولية تشمل الفحص وتخطيط العلاج",
          "نوفر رعاية أسنان مريحة وعصرية في بيئة مريحة"
        ]
      }
    }
  };
